...
public class Motor_Hibrido_Atomic {
    ...
    public Motor_Hibrido_Atomic(String filePath, int cores) {
    ...
    private Map<String, Integer> calcularIDFParcialConsolidado(Segment seg, AtomicLong totalDocs) {
    ...
    private void processarLinhas(List<String> linhas, Map<String, Integer> idf, AtomicLong totalDocs, String out) {
