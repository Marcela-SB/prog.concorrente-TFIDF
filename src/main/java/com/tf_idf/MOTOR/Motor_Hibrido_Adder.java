...
public class Motor_Hibrido_Adder {
    ...
    public Motor_Hibrido_Adder(String filePath, int cores) {
        this.filePath = filePath;
        this.cores = cores;
    }
    
    private final LongAdder totalDocuments = new LongAdder();
    ...
    private Map<String, Integer> calcularIDFParcialConsolidado(Segment seg, LongAdder totalDocs) {
    ...
    private void processarLinhas(List<String> linhas, Map<String, Integer> idf, LongAdder totalDocs, String out) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(out))) {
            ...
            for (String row : linhas) {
                ...
                for (Map.Entry<String, Integer> entry : freq.entrySet()) {
                    ...
                    if (docFreq != null) {
                        double score = calculator.calcularScore(entry.getValue(), totalPalavrasNaLinha, totalDocs.sum(), docFreq);
